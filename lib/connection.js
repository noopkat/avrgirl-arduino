...
Connection.prototype._setUpSerial = function(callback) {
  ...
  this.serialPort.on('open', function() { _this.emit(events.connection.open) });
  this.serialPort.on('close', function() { _this.emit(events.connection.close) });
